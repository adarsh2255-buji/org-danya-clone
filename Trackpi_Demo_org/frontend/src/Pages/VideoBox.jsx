...
const trackerWidth = isWider ? "w-[95vw] top-[85vh]" : "w-[66.04vw]";
...
<div className={`absolute left-[1vw] ${trackerWidth} bottom-[5vh]`}>
  ...
  >
    ...
    ></div>
      ...
      {/* Description */}
      <div className="w-[22.29vw] h-[6.57vh] gap-[0.52vw] mt-[2vh] ">
...
//           : "absolute top-[17.73vh] left-[25.1vw] w-[80%] max-w-[69.04vw] h-auto md:h-[76.61vh] ml-2 lg:ml-8"
//       }`}
//     >
//       {/* Video Container */}
...
//           ref={containerRef}
//           className={`w-full ${
//             isWider ? "h-screen" : "aspect-video md:h-[76.61vh] lg:w-[69.04vw]"
...
//               isWider ? "translate-x-[19vw] translate-y-[9vh]" : ""
//             }`}
//           >
//             <button
//               onClick={handlePlay}
...
//                 alt="Play Video"
//                 className={`${
//                   isWider ? "w-[5vw] h-[5vw]" : "w-[4.86vw] h-[4.86vw]"
//                 }`}
//               />
//             </button>
//           </div>
...
//         {/* Progress Bar */}
//         <div
//           className={`absolute left-4 right-4 bottom-4 md:bottom-6 ${
//             isWider ? "w-[95vw]" : "w-[95%] lg:w-[66.04vw]"
//           }`}
//         >
//           <div className="flex justify-between text-white text-sm md:text-base font-['Urbanist']">
//             <span>{formatTime(currentTime)}</span>
//             <span>{formatTime(duration)}</span>
//           </div>
//           <div
//             className="relative h-2 bg-gray-400 rounded-full cursor-pointer"
//             onClick={handleSeek}
//           >
//             <div
//               id="progress-fill"
...
//             isWider
//               ? "bottom-[1vh] w-[3vw] h-[5vh] text-2xl"
//               : "bottom-[2vh] w-[2.08vw] h-[3.33vh] text-xl"
//           }`}
//         >
//           ⟳
//         </button>
...
//             isWider
//               ? "right-[5vw] bottom-[9vh] w-[0.9vw] h-[2vh]"
//               : "right-[2.3vh] bottom-[2vh] w-[0.9vw] h-[2vh]"
//           }`}
//         >
//           <button
//             onClick={() => setIsWider(!isWider)}
...
//       {/* Description */}
//       <div className=" w-[80%] lg:w-[22.29vw] h-auto md:h-[6.57vh]">
//         <h5 className="text-white font-['Roboto'] font-medium text-lg md:text-xl lg:text-[1.56vw] ml-2">
//           {title}
//         </h5>
//         <p className="text-white font-['Roboto'] font-light text-sm md:text-base lg:text-[1.15vw] ml-2">
//           {description}
//         </p>
//       </div>
