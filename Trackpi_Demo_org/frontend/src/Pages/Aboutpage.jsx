    ...
    />
          ...
          <div className="flex flex-col w-full max-w-[1728px] mx-auto px-[20px] md:px-[90px] gap-[60px] pt-[40px]">
            ...
            <div className="flex flex-col md:flex-row w-full h-auto md:h-[500px] gap-[20px] md:gap-[80px] px-[5px] md:px-0 mt-0 md:mt-[36px] mx-auto">
              ...
              {/* Right */}
              <div className="w-full md:w-[590px] h-auto md:h-[500px] flex justify-center items-center md:items-start">
                <img
                  src="/aboutimg1.png"
                  alt="About Trackpi"
                  className="w-[218px] h-[184px] rounded-[10px] md:w-[400px] md:h-[300px] md:rounded-xl object-contain"
                />
              </div>
            </div>
            ...
            <div className="w-full max-w-[1728px] h-auto md:h-[626px] flex flex-col-reverse md:flex-row gap-[40px] md:gap-[80px] mx-auto px-[16px] md:px-0 mt-0 md:-mt-[200px]">
              {/* Left Side - Image */}
              <div className="w-full md:max-w-[600px] h-auto md:h-[626px] flex justify-center items-center rounded-xl overflow-hidden">
                <img
                  src="/aboutimg2.png"
                  alt="About Trackpi"
                  className="w-[218px] h-[184px] rounded-[10px] md:rounded-xl md:w-[600px] md:h-[500px] object-cover"
                />
              </div>
            ...
            <div className="flex flex-col md:flex-row w-full h-auto gap-[20px] md:gap-[80px] mt-[40px] md:mt-0 px-[16px] md:px-0">
              ...
              {/* Right */}
              <div className="flex justify-center md:block rounded-[10px] md:rounded-xl overflow-hidden">
                <img
                  src="/aboutimg3.png"
                  alt="About Trackpi"
                  className="w-[218px] h-[184px] md:w-[400px] md:h-[300px] object-contain"
                />
              </div>
            </div>
          </div>
